...
O SistemaSAF tem como objetivo auxiliar na organização e manipulação das informações financeiras de clubes de futebol estruturados como Sociedade Anônima do Futebol (SAF).
...
- Ter controle sobre as operações realizadas no sistema, por meio do histórico de auditoria.
...
Como o sistema é voltado para SAFs, então é possível cadastrar mais de um clube no sistema, além de que cada informação registrada (transação, partida, jogador, dentre outras) são associadas ao clube que está sendo operado no momento.
...
- Administração de auditorias do sistema.
...
**Gestor Financeiro (GF):** Tem acesso exclusivamente às funcionalidades relacionadas à gestão financeira do clube: registro e edição de despesas, receitas, transferências de jogadores e geração de relatórios financeiros. Não tem acesso a funcionalidades administrativas de partidas, clubes, relatório de desempenho futebolístico e histórico de auditoria. Corresponde ao diretor financeiro ou gerente administrativo.

**Operador (Op):** Possui acesso limitado, podendo apenas registrar, editar, excluir e consultar partidas. Pode também gerar relatórios de desempenho esportivo. Não tem acesso a nenhuma funcionalidade financeira. Corresponde a analistas de futebol ou assistentes técnicos.
...
- **RF04.1 – Restringir cadastro de usuário ao Adm:** somente o Adm pode acessar a tela de cadastro de novos usuários; GF e Op não podem acessar essa opção no sistema. (O)  
...
- **RF04.4 - Preservar histórico de auditoria do usuário cadastrado:** ao cadastrar um usuário, o sistema deve manter os registros de auditoria do responsável. (O)
...
- **RF05.2 - Preservar histórico de auditoria do usuário alterado:** ao editar um usuário, o sistema deve manter os registros de auditoria do responsável. (O)
...
- **RF06.1 – Restringir exclusão de usuário ao Adm:** somente o Adm pode excluir usuários; GF e Op não podem acessar essa opção no sistema. (O)  
...
- **RF07.1 – Não há restrição de listagem de usuários:** todos os cargos podem listar usuários. (O)  
...
- **RF08.1 – Restringir cadastro de clube:** somente o Adm pode cadastrar clubes; GF e Op não podem acessar essa opção no sistema. (O)  
...
- **RF08.4 - Preservar histórico de auditoria do clube cadastrado:** ao cadastrar um clube, o sistema deve manter os registros de auditoria do responsável. (O)

**RF09 – Editar clube:** o sistema deve permitir editar as informações de um clube já cadastrado. (E)

- **RF09.1 – Restringir alteração de clube:** somente o Adm pode editar informações de clubes; GF e Op não podem acessar essa opção no sistema. (O)

- **RF09.2 - Preservar histórico de auditoria do clube alterado:** ao editar um clube, o sistema deve manter os registros de auditoria do responsável. (O)

**RF10 – Excluir clube:** o sistema deve permitir excluir o cadastro de um clube. (E)
...
- **RF10.2 – Excluir dados vinculados ao clube:** o sistema deve remover todos os registros diretamente associados ao clube. (O)

- **RF10.3 – Preservar histórico de auditoria do clube excluído:** ao excluir um clube, o sistema deve manter os registros de auditoria de exclusão associados a ele. (O)

**RF11 – Listar clubes:** o sistema deve exibir todos os clubes cadastrados com suas informações básicas em formato de lista. (E)

- **RF11.1 – Restringir listagem de clubes ao Adm:** somente o Adm pode acessar a lista de clubes cadastrados; GF e Op não podem acessar essa tela. (O)

- **RF11.2 - Buscar clube:** o sistema deve permitir localizar um clube específico na listagem através do seu identificador. (E)

#### Gerenciamento de Jogadores

**RF12 – Cadastrar jogador:** o sistema deve permitir cadastrar jogadores vinculados a um clube. (E)

- **RF12.1 – Restringir cadastro de jogador a Adm e GF:** somente Adm e GF podem cadastrar jogadores; Op não pode acessar essa opção. (O)  
...
- **RF12.4 - Preservar histórico de auditoria do jogador cadastrado:** ao cadastrar um jogador, o sistema deve manter os registros de auditoria do responsável. (O)
...
- **RF13.1 – Restringir alteração de jogador a Adm e GF:** somente Adm e GF podem editar informações de jogadores; Op não pode acessar essa opção. (O)

- **RF13.2 - Preservar histórico de auditoria do jogador alterado:** ao editar um jogador, o sistema deve manter os registros de auditoria do responsável. (O)

**RF14 – Excluir jogador:** o sistema deve permitir excluir o cadastro de um jogador, desvinculando-o do clube. (E)

- **RF14.1 – Restringir exclusão de jogador a Adm e GF:** somente Adm e GF podem excluir jogadores; Op não pode acessar essa opção. (O)

- **RF14.2 – Preservar histórico de auditoria do jogador excluído:** ao excluir um jogador, o sistema deve manter os registros de auditoria associados a ele. (O)

**RF15 – Listar jogadores:** o sistema deve exibir todos os jogadores vinculados a um clube, apresentando as informações deles. (E)

- **RF15.1 – Restringir listagem de jogadores a Adm e GF:** somente Adm e GF podem acessar a lista de jogadores; Op não pode acessar essa tela. (O)

- **RF15.2 - Buscar jogador:** o sistema deve permitir localizar um jogador específico na listagem através do nome. (E)
...
- **RF16.1 – Restringir registro de compra a Adm e GF:** somente Adm e GF podem registrar compras de jogadores; Op não pode acessar essa opção. (O)  
    
- **RF16.2 – Lançar compra como despesa automaticamente:** o sistema deve registrar o valor de compra e primeiro salário como despesas financeiras automaticamente, ao registrar uma compra de jogador. (O)  
...
- **RF16.6 – Valor da compra:** o valor da compra corresponde ao valor de mercado atual do jogador. (E)  

**RF17 – Registrar venda de jogador:** o sistema deve permitir registrar a venda de um jogador. (E)

- **RF17.1 – Restringir registro de venda a Adm e GF:** somente Adm e GF podem registrar vendas de jogadores; Op não pode acessar essa opção. (O)  
...
- **RF17.5 – Valor da venda:** o valor da venda corresponde ao valor de mercado atual do jogador. (E)  
...
- **RF18.1 – Restringir registro de empréstimo de saída a Adm e GF:** somente Adm e GF podem registrar empréstimos de saída; Op não pode acessar essa opção. (O)  
    
- **RF18.2 – Informações de empréstimo:** o sistema deve conter as seguintes informações da venda do jogador: (E)  
    
  - Jogador que foi emprestado;  
  - Valor de empréstimo (valor de mercado).
...
- **RF19.1 – Restringir registro de empréstimo de entrada a Adm e GF:** somente Adm e GF podem registrar empréstimos de entrada; Op não pode acessar essa opção. (O)  
...
- **RF20.1 – Restringir registro de despesas a Adm e GF:** somente Adm e GF podem registrar despesas; Op não pode acessar essa opção. (O)
...
- **RF20.2.7 – Registrar despesa de transferências:** o sistema deve permitir registrar gastos com transferência de jogadores. (E)  
...
- **RF20.5 - Preservar histórico de auditoria da despesa cadastrada:** ao cadastrar uma despesa, o sistema deve manter os registros de auditoria do responsável. (O)

**RF21 – Editar despesa:** o sistema deve permitir editar qualquer campo de uma despesa já registrada. (E)

- **RF21.1 – Restringir alteração de despesas a Adm e GF:** somente Adm e GF podem editar despesas; Op não pode acessar essa opção. (O)  
    
- **RF21.2 - Preservar histórico de auditoria da despesa alterada:** ao editar uma despesa, o sistema deve manter os registros de auditoria do responsável. (O)
...
- **RF22.1 – Restringir exclusão de despesas a Adm e GF:** somente Adm e GF podem excluir despesas; Op não pode acessar essa opção. (O)  
...
- **RF22.4 – Preservar histórico de auditoria da despesa excluída:** ao excluir uma despesa, o sistema deve manter os registros de auditoria associados a ele. (O)
...
- **RF25.1 – Restringir registro de receitas a Adm e GF:** somente Adm e GF podem registrar receitas; Op não pode acessar essa opção. (O)
...
- **RF25.2.6 – Registrar receita de transferências:** o sistema deve permitir registrar ganhos com transferência de jogadores. (E)
    
- **RF25.2.7 – Registrar outras receitas:** o sistema deve permitir registrar receitas que não se enquadram nas categorias anteriores, exigindo descrição detalhada do lançamento. (E)  
...
- **RF25.5 - Preservar histórico de auditoria da receita cadastrada:** ao cadastrar uma receita, o sistema deve manter os registros de auditoria do responsável. (O)

**RF26 – Editar receita:** o sistema deve permitir editar qualquer campo de uma receita já registrada. (E)

- **RF26.1 – Restringir alteração de receitas a Adm e GF:** somente Adm e GF podem editar receitas; Op não pode acessar essa opção. (O)  
    
- **RF26.2 - Preservar histórico de auditoria da receita alterada:** ao editar uma receita, o sistema deve manter os registros de auditoria do responsável. (O)
...
- **RF27.1 – Restringir exclusão de receitas a Adm e GF:** somente Adm e GF podem excluir receitas; Op não pode acessar essa opção. (O)  
...
- **RF27.4 – Preservar histórico de auditoria da receita excluída:** ao excluir uma receita, o sistema deve manter os registros de auditoria associados a ele. (O)
...
- **RF30.2 – Restringir visualização do saldo a Adm e GF:** o valor do saldo financeiro do clube não deve ser acessível a usuários com perfil Op. (O)
...
- **RF31.1 – Restringir registro de partidas a Adm e Op:** somente Adm e Op podem registrar partidas; GF não pode acessar essa opção. (O)  
...
- **RF31.8 - Preservar histórico de auditoria da partida cadastrada:** ao cadastrar uma partida, o sistema deve manter os registros de auditoria do responsável. (O)

**RF32 – Editar partida:** o sistema deve permitir editar qualquer informação de uma partida já registrada. (E)

- **RF32.1 – Restringir alteração de partidas a Adm e Op:** somente Adm e Op podem editar partidas; GF não pode acessar essa opção. (O)  
    
- **RF32.2 - Preservar histórico de auditoria da partida alterada:** ao editar uma partida, o sistema deve manter os registros de auditoria do responsável. (O)
...
- **RF33.1 – Restringir exclusão de partidas a Adm e Op:** somente Adm e Op podem excluir partidas; GF não pode acessar essa opção. (O)  
    
- **RF33.2 – Remover receita de bilheteria vinculada:** ao excluir a partida, o sistema deve remover automaticamente o valor da bilheteria do registro de receitas. (O)  

- **RF33.3 – Remover receita de premiação vinculada:** ao excluir a partida, o sistema deve remover automaticamente o valor da premiação do registro de receitas. (O)  
...
- **RF33.5 – Preservar histórico de auditoria da partida excluída:** ao excluir uma partida, o sistema deve manter os registros de auditoria associados a ele. (O)

**RF34 – Listar partidas:** o sistema deve exibir todas as partidas registradas. (E)

- **RF34.1 – Restringir listagem de partidas a Adm e Op:** somente Adm e Op podem visualizar o histórico de partidas; GF não pode acessar essa tela. (O)
...
- **RF35.1 – Restringir busca de partidas a Adm e Op:** somente Adm e Op podem buscar partidas; GF não pode acessar essa funcionalidade. (O)

#### Relatórios

**RF36 – Gerar relatório de despesas:** o sistema deve gerar relatório de despesas exibindo o total gasto por categoria e por período, com representação gráfica (barra) e listagem detalhada dos lançamentos. (E)

- **RF36.1 – Restringir relatório de despesas a Adm e GF:** somente Adm e GF podem gerar e visualizar relatórios de despesas; Op não pode acessar essa opção. (O)  
...
**RF37 – Gerar relatório de receitas:** o sistema deve gerar relatório de receitas exibindo o total recebido por categoria e por período, com representação gráfica (pizza) e listagem detalhada dos lançamentos. (E)

- **RF37.1 – Restringir relatório de receitas a Adm e GF:** somente Adm e GF podem gerar e visualizar relatórios de receitas; Op não pode acessar essa opção. (O)  
...
**RF38 – Gerar relatório financeiro geral:** o sistema deve gerar relatório consolidado com total de receitas, total de despesas, saldo resultante e representação gráfica (linha) da evolução do saldo ao longo de um período. (E)

- **RF38.1 – Restringir relatório financeiro geral a Adm e GF:** somente Adm e GF podem gerar e visualizar o relatório financeiro geral; Op não pode acessar essa opção. (O)  
...
**RF39 – Gerar relatório de partidas:** o sistema deve gerar relatório de desempenho esportivo com gráficos Aproveitamento de Pontos e Histórico de Gols. (E)

- **RF39.1 – Restringir relatório de partidas:** Somente Adm e Op podem gerar e visualizar relatórios de partidas; GF não pode acessar essa opção. (O)  
...
**RF40 – Registrar histórico de inserções:** o sistema deve registrar automaticamente um log de cada novo dado inserido, contendo tipo da operação, identificador do dado, tabela afetada, data e usuário responsável. (O)
...
- **RF40.2 – Armazenar auditoria do dado registrado:** o sistema deve armazenar a operação, data, o identificador do registro, tabela afetada, identificador do clube, identificador do responsável e nome do responsável que realizou a operação. (O)
...
- **RF41.2 – Armazenar auditoria do dado alterado:** o sistema deve armazenar a operação, data, o identificador do registro, tabela afetada, identificador do clube, identificador do responsável e nome do responsável que realizou a operação. (O)
...
- **RF42.2 – Armazenar auditoria do dado excluído:** o sistema deve armazenar a operação, data, o identificador do registro, tabela afetada, identificador do clube, identificador do responsável e nome do responsável que realizou a operação. (O)

**RF43 – Listar auditorias:** o sistema deve exibir todas as auditorias registradas. (E)

- **RF43.1 – Restringir listagem de auditorias a Adm:** somente Adm pode visualizar o histórico de auditorias; GF e Op não têm acesso a essa tela. (O)

**RF44 – Buscar auditoria:** o sistema deve permitir localizar uma(s) auditoria(s), indicando: tipo de operação, nome do responsável e tabela afetada. (E)

- **RF44.1 – Restringir busca de auditorias a Adm:** somente Adm pode buscar auditorias; GF e Op não tem acesso a essa funcionalidade. (O)
...
**RNF05 – Mensagens de erro claras:** o sistema deve exibir mensagens de erro em linguagem simples e objetiva, indicando o que ocorreu. (E)

**RNF06 – Confirmação de operações irreversíveis:** o sistema deve solicitar confirmação explícita antes de executar operações irreversíveis, como exclusões de alguns registros (despesa e receita). (E)
...
**RNF11 – Tratamento de erros internos:** o sistema deve tratar internamente todas as exceções não esperadas, exibindo uma mensagem de erro ao usuário. (O)

#### Segurança

**RNF12 – Controle de acesso baseado em perfil:** o sistema deve garantir que nenhuma funcionalidade restrita possa ser acessada por um usuário sem o nível de permissão adequado. (O)

**RNF13 – Sessão invalidada após logout:** após o encerramento de sessão, o sistema deve invalidar completamente os dados da sessão anterior, impedindo acesso a qualquer funcionalidade protegida sem nova autenticação. (O)

**RNF14 – Proteção de dados financeiros:** as informações financeiras do clube — saldo, receitas, despesas e transações com jogadores — devem ser acessíveis somente a usuários com perfil Adm ou GF, nunca sendo exibidas ao Op. (O)

**RNF15 – Imutabilidade do histórico de auditoria:** os registros do histórico de auditoria não devem poder ser editados ou excluídos por nenhum usuário do sistema. (O)

#### Portabilidade

**RNF16 – Compatibilidade com múltiplos sistemas operacionais:** o sistema deve ser executável em sistemas operacionais como Windows, Linux e macOS. (O)

**RNF17 – Independência de serviços externos:** o sistema não deve depender de serviços remotos, conexão com internet ou servidores externos para funcionar. (O)
...
- **RI01.1 – Permitir acesso de itens:** o sistema deve exibir na navegação principal todos módulos e funcionalidades. (E)

- **RI01.2 – Não permitir acesso aos itens não correspondentes ao cargo:** o sistema deve tornar inacessível os módulos e funcionalidades que não são do cargo do usuário. (E)

**RI02 – Tela de login:** o sistema deve apresentar um formulário de autenticação contendo campos para nome de usuário e senha. (E)
...
- **RI04.1 – Exibir mensagens de validação inline:** o sistema deve exibir mensagens de erro de validação quando tiver problema com algum campo, sem redirecionar o usuário para outra tela. (E)  
    
- **RI04.2 – Informar campos de preenchimento obrigatório:** o sistema deve indicar visualmente os campos de preenchimento obrigatório. (E)
...
- **RI05.3 – Exibir lista vazia:** quando não houver registros, o sistema deve apresentar uma lista vazia. (E)
...
**RI08 – Telas de relatório:** o sistema deve apresentar os relatórios gerados em tela dedicada, com as informações específicas daquele relatório. (E)

- **RI08.1 – Exibir representação gráfica nos relatórios financeiros:** o sistema deve apresentar, nos relatórios de despesas e receitas e financeiro geral, gráfico de barras, pizza ou linha. (E)  
    
- **RI08.2 – Exibir filtros de relatório em área dedicada:** o sistema deve apresentar os filtros disponíveis para cada relatório. (E)

**RI09 – Padrão visual consistente:** o sistema deve manter padronização visual uniforme em todas as telas. (E)

**RI10 – Exibir saldo atual na tela principal:** o sistema deve exibir o saldo financeiro atual do clube em destaque no dashboard de qualquer usuário. (E)
...
**RI12 – Requisitos de exibição:** o sistema deve ser executável e utilizável em monitores com resolução mínima de 1024x768 pixels. (O)

**RI13 – Ausência de dependência de hardware especializado:** o sistema não requer quaisquer outros periféricos além dos dispositivos de entrada e saída padrão. (O)
...
**RI14 – Interface com o sistema operacional:** o sistema deve interagir com o sistema operacional hospedeiro exclusivamente por meio da JVM (Java Virtual Machine), não realizando chamadas diretas a APIs. (O)

**RI15 – Interface com o banco de dados relacional:** o sistema deve se comunicar com o banco de dados relacional. (O)

- **RI15.1 – Encerrar conexões com o banco de dados após cada operação:** o sistema deve garantir que as conexões abertas com o banco de dados sejam encerradas ao término de cada operação. (O)

**RI16 – Ausência de integração com sistemas externos:** o sistema não realiza integração com APIs externas, portais de federações de futebol ou sistemas bancários. (O)

- **RI16.1 – Ausência de dependência de conexão com a internet:** o sistema deve operar em sua totalidade sem necessidade de conexão com a internet. (O)
...
**RI17 – Comunicação local com o banco de dados:** toda a troca de dados entre o sistema e o banco de dados relacional deve ocorrer localmente. (O)

**RI18 – Ausência de protocolos de comunicação em rede:** o sistema não depende de protocolos de comunicação em rede. (O)
...
O saldo financeiro do clube, calculado e mantido automaticamente pelo sistema obedece à seguinte regra geral:

**Saldo \= Σ Receitas Registradas − Σ Despesas Registradas**

Para fins deste cálculo, consideram-se:

- **Receitas:** todos os lançamentos dos módulos de Gerenciamento de Receitas, as receitas geradas automaticamente pelo registro de venda de jogador e pela bilheteria calculada no módulo de Partidas;  
- **Despesas:** todos os lançamentos do módulo de Gerenciamento de Despesas, as despesas geradas automaticamente pelo registro de compra de jogador.

O saldo é recalculado automaticamente a cada inserção, edição ou exclusão de qualquer lançamento de receita ou despesa. O sistema não permite que o saldo exibido ao usuário divirja do valor calculado a partir dos registros presentes na base de dados.

### **Apêndice D – Estrutura de Dados do Histórico de Auditoria**

O histórico de auditoria registra automaticamente todas as operações de inserção e edição realizadas no sistema. Cada registro de auditoria contém os seguintes atributos mínimos:

| Atributo | Descrição |
| :---- | :---- |
| **Tipo de operação** | Indica se o evento é uma inserção ou uma edição de registro |
| **Tipo do dado ou Tabela afetada** | Categoria do registro afetado: despesa, receita, partida, jogador, usuário ou clube |
...
| **Data** | Carimbo de tempo da operação, registrado no momento de sua execução |
...
- 3.1 Requisitos Funcionais  
  ...
  - Módulo 11 – Histórico de Auditoría (RF40–RF44)


- 3.2 Requisitos Não Funcionais  
    
  - Desempenho (RNF01–RNF03)  
  - Usabilidade (RNF04–RNF08)  
  - Confiabilidade (RNF09–RNF11)  
  - Segurança (RNF12–RNF15)  
  - Portabilidade (RNF16–RNF17)


- 3.3 Requisitos de Interface  
    
  - 3.3.1 Interface de Usuário (RI01–RI10)  
  - 3.3.2 Interface com Hardware (RI11–RI13)  
  - 3.3.3 Interface com Software Externo (RI14–RI16)  
  - 3.3.4 Interface de Comunicação (RI17–RI18)
